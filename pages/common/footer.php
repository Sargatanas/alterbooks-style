    ...
    <div class="footer__area">
        ...
        <div class="footer-social footer-block">
            ...
            <div class="footer-social__area">
                <div class="footer-social__element footer-social__element_vk"></div>
                <div class="footer-social__element footer-social__element_facebook"></div>
                <div class="footer-social__element footer-social__element_twitter"></div>
            </div>
